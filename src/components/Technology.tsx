...
const features: Array<{ title: string; body: string; icon: string }> = [
  ...
  },
  {
    ...
    body:
      "Author rules in HCL, YAML, or the Console UI. Commit them alongside infrastructure so every policy change is version‑controlled and reviewed.",
    icon: "</>",
  },
  {
    title: "SaaS or self hosted",
    body:
      "Run the Console in Formal’s cloud for zero ops, or host it yourself for full isolation; either way, data never leaves your side of the VPC boundary.",
    icon: "☁",
  },
  {
    title: "Stateless by design",
    body:
      "Connector pods keep zero session state, letting you scale horizontally, roll upgrades without downtime, and fail over automatically across availability zones.",
    icon: "♻",
  },
  {
    title: "Built for audits",
    body:
      "Export tamper‑evident logs, diffable policy bundles, and ready‑made SOC 2, HIPAA, and GDPR control mappings to make evidence collection pain‑free.",
    icon: "🔍",
  },
];
